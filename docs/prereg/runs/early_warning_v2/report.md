# Pre-registered early-warning evaluation — run report (early_warning_v2)

*Run at 2026-09-17T14:07:39+00:00 against tag `prereg-early-warning-v2`. Single-run rule: these numbers are the run.*
...
| `FRED_T10Y3M` | evaluated | 19 | 0.062 | 0.663 | 0.142 | 0.0010 | 18.5 | 10.325 | yes | fail |
| `FRED_VIXCLS` | evaluated | 16 | 0.044 | 0.926 | 0.395 | 0.0010 | 11.5 | 8.921 | no | fail |

## Criteria (frozen pre-run, identical to every protocol version)
...
- early_warning_v2 runs in-process rather than via the Celery job queue (protocol section 'Execution'); the computation mirrors run_backtest's event idiom
