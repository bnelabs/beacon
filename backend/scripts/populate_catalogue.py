    ...
    try:
        ...
        catalogue_items = [
            ...
            # ============================================
            {
                ...
                "description": "Banking sector financial soundness indicators (US Capital Adequacy)",
                "category": DataCategory.BANKING,
                "region": DataRegion.GLOBAL,
                "risk_types": [RiskType.SYSTEMIC_RISK.value, RiskType.CREDIT_RISK.value],
                "data_source_id": sources["IMF"].id,
                "endpoint": "FSI.A.US.FSIRE_PA_PT",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage",
            ...
            },
            {
                ...
                "description": "Foreign exchange reserves and reserve assets (US)",
                "category": DataCategory.CENTRAL_BANK,
                "region": DataRegion.NORTH_AMERICA,
                "risk_types": [RiskType.FUNDING_LIQUIDITY.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["IMF"].id,
                "endpoint": "IFS.M.US.RAFA_BP6_USD",
                "frequency": "monthly",
                "granularity": "macro",
                "unit": "USD millions",
                "default_selected": True,
            ...
            },
            {
                ...
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "USA.FS.AST.PRVT.GD.ZS",
                "frequency": "annual",
                "granularity": "macro",
            ...
            {
                "code": "WB_BANK_NPL_IN",
                "name": "World Bank Bank Non-Performing Loans (India)",
                "description": "Bank nonperforming loans to gross loans ratio - India",
                "category": DataCategory.CREDIT_MARKETS,
                "region": DataRegion.ASIA,
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "IND.FB.AST.NPER.ZS",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage",
                "default_selected": True,
                "priority": 85,
                "tags": ["credit_quality", "npl", "india", "asia"]
            },
            {
                "code": "WB_DOMESTIC_CREDIT_IN",
                "name": "World Bank Domestic Credit to Private Sector (India)",
                "description": "Domestic credit provided by financial sector - India",
                "category": DataCategory.CREDIT_MARKETS,
                "region": DataRegion.ASIA,
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "IND.FS.AST.PRVT.GD.ZS",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage_of_gdp",
                "default_selected": True,
                "priority": 80,
                "tags": ["domestic_credit", "private_sector", "india", "asia"]
            },
            {
                "code": "WB_BANK_NPL_KR",
                "name": "World Bank Bank Non-Performing Loans (South Korea)",
                "description": "Bank nonperforming loans to gross loans ratio - South Korea",
                "category": DataCategory.CREDIT_MARKETS,
                "region": DataRegion.ASIA,
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "KOR.FB.AST.NPER.ZS",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage",
                "default_selected": True,
                "priority": 80,
                "tags": ["credit_quality", "npl", "korea", "asia"]
            },
            ...
            {
                "code": "WB_BANK_NPL_BR",
                "name": "World Bank Bank Non-Performing Loans (Brazil)",
                "description": "Bank nonperforming loans to gross loans ratio - Brazil",
                "category": DataCategory.CREDIT_MARKETS,
                "region": DataRegion.LATIN_AMERICA,
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "BRA.FB.AST.NPER.ZS",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage",
                "default_selected": True,
                "priority": 85,
                "tags": ["credit_quality", "npl", "brazil", "latam"]
            },
            {
                "code": "WB_DOMESTIC_CREDIT_BR",
                "name": "World Bank Domestic Credit to Private Sector (Brazil)",
                "description": "Domestic credit provided by financial sector - Brazil",
                "category": DataCategory.CREDIT_MARKETS,
                "region": DataRegion.LATIN_AMERICA,
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "BRA.FS.AST.PRVT.GD.ZS",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage_of_gdp",
                "default_selected": True,
                "priority": 80,
                "tags": ["domestic_credit", "private_sector", "brazil", "latam"]
            },
            {
                "code": "WB_BANK_NPL_MX",
                "name": "World Bank Bank Non-Performing Loans (Mexico)",
                "description": "Bank nonperforming loans to gross loans ratio - Mexico",
                "category": DataCategory.CREDIT_MARKETS,
                "region": DataRegion.LATIN_AMERICA,
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "MEX.FB.AST.NPER.ZS",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage",
                "default_selected": True,
                "priority": 80,
                "tags": ["credit_quality", "npl", "mexico", "latam"]
            },
            {
                "code": "WB_DOMESTIC_CREDIT_MX",
                "name": "World Bank Domestic Credit to Private Sector (Mexico)",
                "description": "Domestic credit provided by financial sector - Mexico",
                "category": DataCategory.CREDIT_MARKETS,
                "region": DataRegion.LATIN_AMERICA,
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "MEX.FS.AST.PRVT.GD.ZS",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage_of_gdp",
                "default_selected": True,
                "priority": 80,
                "tags": ["domestic_credit", "private_sector", "mexico", "latam"]
            },
            ...
            {
                "code": "WB_BANK_NPL_ZA",
                "name": "World Bank Bank Non-Performing Loans (South Africa)",
                "description": "Bank nonperforming loans to gross loans ratio - South Africa",
                "category": DataCategory.CREDIT_MARKETS,
                "region": DataRegion.AFRICA,
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "ZAF.FB.AST.NPER.ZS",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage",
                "default_selected": True,
                "priority": 80,
                "tags": ["credit_quality", "npl", "south_africa", "africa"]
            },
            {
                "code": "WB_DOMESTIC_CREDIT_ZA",
                "name": "World Bank Domestic Credit to Private Sector (South Africa)",
                "description": "Domestic credit provided by financial sector - South Africa",
                "category": DataCategory.CREDIT_MARKETS,
                "region": DataRegion.AFRICA,
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "ZAF.FS.AST.PRVT.GD.ZS",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage_of_gdp",
                "default_selected": True,
                "priority": 75,
                "tags": ["domestic_credit", "private_sector", "south_africa", "africa"]
            },
            {
                "code": "WB_BANK_NPL_NG",
                "name": "World Bank Bank Non-Performing Loans (Nigeria)",
                "description": "Bank nonperforming loans to gross loans ratio - Nigeria",
                "category": DataCategory.CREDIT_MARKETS,
                "region": DataRegion.AFRICA,
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "NGA.FB.AST.NPER.ZS",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage",
                "default_selected": True,
                "priority": 75,
                "tags": ["credit_quality", "npl", "nigeria", "africa"]
            },
            ...
            {
                "code": "WB_BANK_NPL_SA",
                "name": "World Bank Bank Non-Performing Loans (Saudi Arabia)",
                "description": "Bank nonperforming loans to gross loans ratio - Saudi Arabia",
                "category": DataCategory.CREDIT_MARKETS,
                "region": DataRegion.MIDDLE_EAST,
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "SAU.FB.AST.NPER.ZS",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage",
                "default_selected": True,
                "priority": 75,
                "tags": ["credit_quality", "npl", "saudi_arabia", "mena"]
            },
            {
                "code": "WB_DOMESTIC_CREDIT_SA",
                "name": "World Bank Domestic Credit to Private Sector (Saudi Arabia)",
                "description": "Domestic credit provided by financial sector - Saudi Arabia",
                "category": DataCategory.CREDIT_MARKETS,
                "region": DataRegion.MIDDLE_EAST,
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "SAU.FS.AST.PRVT.GD.ZS",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage_of_gdp",
                "default_selected": True,
                "priority": 75,
                "tags": ["domestic_credit", "private_sector", "saudi_arabia", "mena"]
            },
            {
                "code": "WB_BANK_NPL_AE",
                "name": "World Bank Bank Non-Performing Loans (UAE)",
                "description": "Bank nonperforming loans to gross loans ratio - United Arab Emirates",
                "category": DataCategory.CREDIT_MARKETS,
                "region": DataRegion.MIDDLE_EAST,
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "ARE.FB.AST.NPER.ZS",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage",
                "default_selected": True,
                "priority": 75,
                "tags": ["credit_quality", "npl", "uae", "mena"]
            },

            # ============================================
            # WORLD BANK - ADDITIONAL COUNTRY-LEVEL
            # ============================================
            {
                "code": "WB_BANK_NPL_GB",
                "name": "World Bank Bank Non-Performing Loans (UK)",
                "description": "Bank nonperforming loans to gross loans ratio - United Kingdom",
                "category": DataCategory.CREDIT_MARKETS,
                "region": DataRegion.EUROPE,
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "GBR.FB.AST.NPER.ZS",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage",
                "default_selected": True,
                "priority": 85,
                "tags": ["credit_quality", "npl", "uk", "europe"]
            },
            {
                "code": "WB_BANK_NPL_DE",
                "name": "World Bank Bank Non-Performing Loans (Germany)",
                "description": "Bank nonperforming loans to gross loans ratio - Germany",
                "category": DataCategory.CREDIT_MARKETS,
                "region": DataRegion.EUROPE,
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "DEU.FB.AST.NPER.ZS",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage",
                "default_selected": True,
                "priority": 85,
                "tags": ["credit_quality", "npl", "germany", "europe"]
            },
            {
                "code": "WB_BANK_NPL_FR",
                "name": "World Bank Bank Non-Performing Loans (France)",
                "description": "Bank nonperforming loans to gross loans ratio - France",
                "category": DataCategory.CREDIT_MARKETS,
                "region": DataRegion.EUROPE,
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "FRA.FB.AST.NPER.ZS",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage",
                "default_selected": True,
                "priority": 85,
                "tags": ["credit_quality", "npl", "france", "europe"]
            },
            {
                "code": "WB_BANK_NPL_CA",
                "name": "World Bank Bank Non-Performing Loans (Canada)",
                "description": "Bank nonperforming loans to gross loans ratio - Canada",
                "category": DataCategory.CREDIT_MARKETS,
                "region": DataRegion.NORTH_AMERICA,
                "risk_types": [RiskType.CREDIT_RISK.value, RiskType.SYSTEMIC_RISK.value],
                "data_source_id": sources["World Bank"].id,
                "endpoint": "CAN.FB.AST.NPER.ZS",
                "frequency": "annual",
                "granularity": "macro",
                "unit": "percentage",
                "default_selected": True,
                "priority": 85,
                "tags": ["credit_quality", "npl", "canada", "north_america"]
            },
