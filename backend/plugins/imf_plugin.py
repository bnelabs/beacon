...
class IMFPlugin(DataSourcePlugin):
    ...
    def test_item(self, item_identifier: str) -> Dict[str, Any]:
        """Test IMF indicator with appropriate date range for monthly/quarterly/annual data."""
        try:
            from datetime import timedelta
            # IMF data can be monthly/quarterly/annual, use last 3 years
            ...
            logger.error(f"Error testing IMF item {item_identifier}: {e}")
            return {
                "success": False,
