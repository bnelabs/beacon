...
class BISPlugin(DataSourcePlugin):
    ...
    def test_item(self, item_identifier: str) -> Dict[str, Any]:
        """Test BIS indicator with appropriate date range for quarterly/annual data."""
        try:
            from datetime import timedelta
            # BIS data is quarterly/annual, use last 5 years
            ...
            logger.error(f"Error testing BIS item {item_identifier}: {e}")
            return {
                "success": False,
